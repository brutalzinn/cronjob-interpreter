        ...
        public DateTime CalcularProximaDateTime()
        {
            ...
            switch (ObterTipo())
            {
                ...
                case CronType.ValueListSeperator:
                    dias = FilterValueListSeparator(ProximoDisparo).FirstOrDefault().GetValueOrDefault();
                    break;

                case CronType.RangeOfValues:
                    dias = FilterRangeOfValues(ProximoDisparo).FirstOrDefault().GetValueOrDefault();
                    break;

                case CronType.StepValues:
                    dias = FilterStepValues(ProximoDisparo).FirstOrDefault().GetValueOrDefault();
                    break;
